# Dhruvini Consulting - Website Design Concepts

This repository contains modern design concepts for the Dhruvini Consulting website.

## Design Options
Two distinct design directions have been implemented for client review:
...
3. Start the development server:
   ...
   npm run dev
   ```
4. Open the preview links above.

## Project Structure
- `src/app/design-human`: Contains the "Human" design page.
- `src/app/design-corporate`: Contains the "Corporate" design page.
- `src/lib/data.ts`: Shared data for services and industries.
